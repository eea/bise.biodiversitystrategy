...
class IAction(form.Schema, IImageScaleTraversable):
    """
    ...
    # models/action.xml to define the content type
    # and add directives here as necessary.
    form.model("models/action.xml")
...
# templates called actionview.pt .
